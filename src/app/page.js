    ...
    >
      ...
      >
        ...
        <motion.h4
          ...
          transition={{ duration: 0.6 }}
          className="text-white text-2xl md:text-4xl xl:text-5xl mb-5 lg:mb-10 Oxanium md:mt-10 font-bold text-center"
        >
          Join Whitelist
        </motion.h4>
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: formInView ? 1 : 0, y: formInView ? 0 : 20 }}
          transition={{ duration: 0.6, delay: 0.2 }} // Optional delay for better effect
        ...
        >
          <div className="w-[95%] mx-auto sm:w-[400px] xl:w-[680px] lg:w-[400px] flex-wrap justify-between flex px-2 py-1 xl:py-3 md:pl-7 rounded-[7px] border text-white border-[#5991ff]">
            <input
              className="py-4 sm:w-auto bg-opacity-0 reset-input"
              type="email"
              id="email"
              name="email"
